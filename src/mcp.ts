...
export function createMcpServer(apiKey: string): McpServer {
  ...
  server.tool(
    ...
    (input) => wrap(() => contactCreate(input, apiKey)),
  );
  ...
  server.tool(
    ...
    (input) => wrap(() => webhookCreate(input, apiKey)),
  );
  ...
  server.tool(
    ...
    (input) => wrap(() => webhookGet(input, apiKey)),
  );
  ...
  server.tool(
    ...
    (input) => wrap(() => webhookList(input, apiKey)),
  );
  ...
  server.tool(
    ...
    (input) => wrap(() => webhookDelete(input, apiKey)),
  );
