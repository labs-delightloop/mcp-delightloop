...
export const LinkedInProfileSchema = z.object({
    url: z
        .string()
        .describe("The full LinkedIn profile URL (e.g. https://www.linkedin.com/in/username/). " +
...
export async function linkedInProfileGet(input, apiKey) {
    return dlRequest({
        method: "GET",
...
export async function workEmailGet(input, apiKey) {
    return dlRequest({
        method: "POST",
