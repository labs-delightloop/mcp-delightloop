...
const RESOURCE_FILES = {
    [UI_RESOURCES.campaignDetails]: path.resolve(__dirname, "../ui/dist/campaign-details/index.html"),
    [UI_RESOURCES.campaignList]: path.resolve(__dirname, "../ui/dist/campaign-list/index.html"),
    [UI_RESOURCES.contactList]: path.resolve(__dirname, "../ui/dist/contact-list/index.html"),
    [UI_RESOURCES.contactCard]: path.resolve(__dirname, "../ui/dist/contact-card/index.html"),
    [UI_RESOURCES.recipientList]: path.resolve(__dirname, "../ui/dist/recipient-list/index.html"),
};
const cache = new Map();
